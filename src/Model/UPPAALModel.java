...
public class UPPAALModel implements Externalizable, Cloneable {
    ...
    public boolean equals(Object o) {
        ...
        if (allConfigVars != null ? !allConfigVars.equals(that.allConfigVars) : that.allConfigVars != null)
            return false;
        if (nonConstConfigVars != null ? !nonConstConfigVars.equals(that.nonConstConfigVars) : that.nonConstConfigVars != null)
            return false;
