...
public class SimulationMenuController {
    ...
    @FXML
    public ButtonBar btnBarExportImportVQ;
    @FXML
    public TitledPane simulationPane;
    @FXML
    public TitledPane vqPane;
    @FXML
    private TextArea txtNewVQ;
    @FXML
    private ListView<EnableDisableSimulationOption> lstSimulationOptions;
    @FXML
    private ListView<EnableDisableSimulationOption> lstDisplayOptions;
    @FXML
    private ListView<SimulationOption> lstExportOptions;
