...
public class MainWindowController implements Initializable {
    ...
    @FXML
    public TopologyGeneratorController topologyGeneratorController;
    public boolean constantsChanged;
    @FXML
    private ProgressIndicator simulationProgress;
    @FXML
    private TextArea txtUppaalOutput;
    @FXML
    private TextField txtSimulationName;
    @FXML
    private TableColumn<CVar, String> columnName;
    @FXML
    private TableColumn<CVar, CVar> columnValue;
    @FXML
    private TableColumn<CVar, String> columnScope;
    @FXML
    ...
    @FXML
    private TableColumn<OutputVariable, String> outputVarScope;
    @FXML
    ...
    @FXML
    private TableView<TemplateUpdate> dynamicTable;
    @FXML
    private TableColumn<TemplateUpdate, String> dynColumnName;
    @FXML
    private TableColumn<TemplateUpdate, String> dynColumnValue;
    @FXML
    private TableColumn<TemplateUpdate, Number> dynColumnTime;
    @FXML
    private Tab configurationTab;
    @FXML
    private Button saveModelButton;
    @FXML
    private ToggleSwitch chkUseRandomTopology;
    @FXML
    private Tab topologyGeneratorTab;
