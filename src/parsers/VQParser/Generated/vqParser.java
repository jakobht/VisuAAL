...
public class vqParser extends Parser {
    ...
    public static class QueryContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(vqParser.EOF, 0);
        }
    ...
    public static class OneGradientContext extends ParserRuleContext {
        ...
        public TerminalNode ID() {
            return getToken(vqParser.ID, 0);
        }

        public TerminalNode FLOAT() {
            return getToken(vqParser.FLOAT, 0);
        }

        public TerminalNode NEG() {
            return getToken(vqParser.NEG, 0);
        }
    ...
    public static class ParContext extends ExpContext {
        public ParContext(ExpContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class BoolContext extends ExpContext {
        ...
        public TerminalNode BOOL() {
            return getToken(vqParser.BOOL, 0);
        }
    ...
    public static class IdDotContext extends ExpContext {
        public IdDotContext(ExpContext ctx) {
            copyFrom(ctx);
        }

        public List<TerminalNode> ID() {
            return getTokens(vqParser.ID);
        }
    ...
    public static class IdContext extends ExpContext {
        public IdContext(ExpContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class UnOpContext extends ExpContext {
        ...
        public UnOpContext(ExpContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class FloatContext extends ExpContext {
        public FloatContext(ExpContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class CondOpContext extends ExpContext {
        public CondOpContext(ExpContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class BinOpContext extends ExpContext {
        ...
        public BinOpContext(ExpContext ctx) {
            copyFrom(ctx);
        }
